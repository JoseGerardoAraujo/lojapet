    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Animal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Servico', to='appCadastro.animal')),
            ],
        ),
        migrations.CreateModel(
            name='Cliente',
            fields=[
                ...
                ('endereco', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cliente', to='appCadastro.endereco')),
            ],
        ),
        migrations.AddField(
            model_name='animal',
            name='cliente',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='animal', to='appCadastro.cliente'),
        ),
    ]
